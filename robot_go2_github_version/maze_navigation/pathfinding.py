...
class PathfindingAlgorithms:
    ...
    def __init__(self, maze_env, robot_width=0.35, robot_height=0.35, safety_margin=0.15):
        """
        初始化路径规划算法

        Args:
            maze_env: 迷宫环境对象
            robot_width: 机器人宽度（Go2机器人默认0.35m）
            robot_height: 机器人高度（Go2机器人默认0.35m）
            safety_margin: 安全边距（Go2机器人需要更大的安全边距）
        """
